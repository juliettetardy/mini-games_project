"""
Jeu de la vie avec génération manuelle, créé par lespinx
"""

# Importation des bibliothèques utiles
import os.path, time, pickle
from tkinter import * # ne fonctionne que pour python3
from tkinter.messagebox import showinfo, askyesno # ne fonctionne que pour python3
from tkinter.filedialog import askopenfile # ne fonctionne que pour python3
...
class Grille:
    def __init__(self):
        ...
        self.font2 = "Arial 8 bold"       # Police En-têtes
    ...
    def grille_reinit(self):
        """
        Après modification de la taille d'une cellule, réinitialisation de la
        grille et des paramètres de l'application
        """
        self.cpt_gener = 0          # Compteur de générations
        self.dic_cell_live = {}     # Dictionnaire des cellules en vie à temps t
        self.dic_cell_live_t1 = {}  # Dictionnaire des cellules en vie à temps t+1
    ...
    def double_clic_gauche_listbox(self, event):
        ...
        if askyesno("Jeu de la vie - Suppression du motif", msg1, default = "no", icon = "warning"):
            ...
            fic_motifs = "jeu_de_la_vie/JDV_Motifs_V3.pickle"
            print(fic_motifs)
    ...
    def appli_Tk(self):
        ...
        self.Ecran0.geometry("+240+0")
        self.Ecran0.resizable(0, 0)

###     Création des Frames conteneurs     ###
...
###     Création des widgets de self.Frame_1     ###
...
###     Création des widgets de self.Frame_3     ###
        ...
        self.Arreter = Button(self.LbF_actions, text = 'Arrêter',
            bg = "light yellow", width = 14, takefocus = False,
